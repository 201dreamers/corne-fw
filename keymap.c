...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DFT] = LAYOUT_split_3x6_3(
           ...
           KC_LCTRL,              KC_A,              KC_S,              KC_D,              KC_F,              KC_G,               KC_H,              KC_J,              KC_K,              KC_L,         KC_SCOLON,          KC_QUOTE,
            KC_LALT,              KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,               KC_N,              KC_M,          KC_COMMA,            KC_DOT,          KC_SLASH,         KC_ESCAPE,
                                                                     KC_LGUI,         KC_LSHIFT,           FN_MO13,            FN_MO23,          KC_SPACE,          KC_ENTER
    ),
    ...
    [_LWR] = LAYOUT_split_3x6_3(
     LSFT(KC_GRAVE),        LSFT(KC_1),        LSFT(KC_2),        LSFT(KC_3),        LSFT(KC_4),        LSFT(KC_5),              KC_NO,             KC_NO,             KC_NO,             KC_NO,             KC_NO,           KC_TRNS,
            KC_TRNS,        LSFT(KC_6),        LSFT(KC_7),        LSFT(KC_8),        LSFT(KC_9),        LSFT(KC_0),            KC_LEFT,           KC_DOWN,             KC_UP,          KC_RIGHT,        KC_PSCREEN,       KC_CAPSLOCK,
            KC_TRNS,    LSFT(KC_MINUS),    LSFT(KC_EQUAL),   LSFT(KC_BSLASH), LSFT(KC_LBRACKET), LSFT(KC_RBRACKET),            KC_HOME,            KC_END,           KC_PGUP,         KC_PGDOWN,         KC_DELETE,           KC_TRNS,
